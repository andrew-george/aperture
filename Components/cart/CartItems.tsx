...
function CartItems() {
	...
	return (
		<div className='w-full h-full overflow-y-auto space-y-8 my-4'>
				...
				return (
					<div
						...
						<div className='flex'>
							...
							/>
							<span className='ml-3 text-lg'>x {unitPrice} USD</span>
						</div>
						<div className='text-lg'>{unitPrice * quantity} USD</div>
